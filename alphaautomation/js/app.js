...
***************************************************************************** */
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            const elementsTimer = document.querySelectorAll(".page__item");
            let currentIndexTimer = 0;
            function addActiveClassTimer(array) {
                array.forEach(((element, i) => {
                    if (element.classList.contains("active")) currentIndexTimer = ++i;
                    element.classList.remove("active");
                }));
                if (currentIndexTimer >= array.length) currentIndexTimer = 0;
                array[currentIndexTimer].classList.add("active");
            }
            if (elementsTimer.length) setInterval((() => addActiveClassTimer(elementsTimer)), 1e4);
        }));
        window["FLS"] = true;
        isWebp();
        addLoadedClass();
