(() => {
    ...
    function initSliders() {
        //!Slider ONE
        if (document.querySelector(".history__slider")) new swiper_core_Swiper(".history__slider", {
        ...
        //!Slider TWO
                if (document.querySelector(".collection__slider")) new swiper_core_Swiper(".collection__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 5,
        ...
        //!Slider THREE
                if (document.querySelector(".speaking__slider")) new swiper_core_Swiper(".speaking__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
...
***************************************************************************** */
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        const countdown = () => {
            ...
            if (timeLeft <= 0) document.getElementById("countdown").innerHTML = "Время истекло!"; else {
                ...
                document.getElementById("countdown").innerHTML = `<span class="countdown-letter">${days}</span>д <span class="countdown-letter">${hours}</span>ч <span class="countdown-letter">${minutes}</span>м <span class="countdown-letter">${seconds}</span>с`;
            }
        };
        countdown();
        setInterval(countdown, 1e3);
        const pageInformation = document.querySelector(".page__information");
        const blocks = document.querySelectorAll(".information__block");
        const numbers = document.querySelectorAll(".information__numbers");
        const targetValues = [ 11743, 535, 250000 ];
        function startAnimation() {
            ...
            observer.observe(pageInformation);
        }
        ...
        function animateNumbers(index) {
            ...
            const step = targetNumber / animationDuration * 10;
